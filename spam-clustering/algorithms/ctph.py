...
class SpamCluster:
    ...
    def add(self, files):
        ...
        Keyword arguments:
        files -- List of file names to add to this cluster, or a string for a
                 single file.
        """
        if files is None:
            pass
...
class ClusteringAlgorithm:
    ...
    def __init__(self, input_list, output_path):
        ...
        Key arguments:
        input_list -- List of file names to process.
        output_path -- String which contains the path to the location to which
        all cluster should be written.
        """
...
class Ctph(ClusteringAlgorithm):
    ...
    """
    # Defines the value used as threshold when comparing two hash values.
    threshold_value = 85
